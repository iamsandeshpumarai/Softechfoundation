...
data[0]?.stats?.map((exampleCompany,index)=>{
    return <div key={index} className='border md:w-[75%] w-[90%]  mb-3 h-[170px] md:h-[200px]  cursor-pointer flex flex-col justify-center items-center bg-gradient-to-r from-[#F3FEFF] to-white shadow-lg rounded-md'>
        <div className='statnum sm:h-[30%] md:h-[30%] text-blue-600 font-semibold text-[20px] text-center md:text-[30px]'>
{exampleCompany.title}
</div>
<div className='stattext  text-center  font-light md:font-normal ml-5'>
